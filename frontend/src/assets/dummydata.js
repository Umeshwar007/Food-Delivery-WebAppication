...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.facebook.com/share/16DCoFzdXH/', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/umeshwar_799?igsh=MXEyNTUybDVlZDdtcg==', color: '#E1306C', label: 'Instagram' },
    
    { icon: FaYoutube, link: 'https://www.youtube.com/@umeshwar4645', color: '#FF0000', label: 'Youtube' },
];
